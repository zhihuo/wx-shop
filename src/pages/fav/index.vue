<template>
  <div class="typelist-area">
    ...
    <!--展示列表-->
    <div class="weui-grids" v-if="copyCollectlist.length >= 1">
      <navigator v-for="(item,index) in copyCollectlist" :key="index" :url="item.url" class="weui-grid search-hot-list__item" hover-class="weui-grid__active">
    ...
    <div v-if="copyCollectlist.length < 1">
      暂无收藏
    </div>
  </div>
</template>
